...
- event_name은 같은 사건이면 최대한 같은 이름이 나오도록 구체적으로 작성합니다.
- event_name은 기사 제목과 핵심 사건을 중심으로 작성합니다.
- 부가 설명이나 낮은 비중의 내용은 event_name에 넣지 마세요.
...
- event_keywords는 기사 핵심 사건을 설명하는 단어만 3~7개 포함합니다.
- event_keywords는 기사 제목 또는 본문에 실제 등장하거나 핵심 사건에서 직접 도출 가능한 단어만 사용합니다.
- 부가 설명, 예시, 배경 정보, 향후 계획은 핵심 키워드로 넣지 마세요.
